package sv.edu.udb.dsm.guia3.guia4;
...
import sv.edu.udb.dsm.guia3.guia4.datos.Persona;
    ...
    private void inicializar() {
        ...
        consultaOrdenada.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                AdaptadorPersona adapter = new AdaptadorPersona(PersonasActivity.this,personas );
